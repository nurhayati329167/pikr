    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            (s.prototype.slice = function(t, e) {
                ...
                for (
                    var n = [], r = l.iterator(this.ops), o = 0; o < e && r.hasNext();
            ...
            (s.prototype.compose = function(t) {
                for (
                    var e = l.iterator(this.ops), n = l.iterator(t.ops), r = new s(); e.hasNext() || n.hasNext();
            ...
            (s.prototype.eachLine = function(t, e) {
                e = e || "\n";
                for (
                    var n = l.iterator(this.ops), r = new s(), o = 0; n.hasNext();
            ...
            (s.prototype.transform = function(t, e) {
                ...
                for (
                    var n = l.iterator(this.ops), r = l.iterator(t.ops), o = new s(); n.hasNext() || r.hasNext();
        ...
        function(t, e, n) {
            ...
            function l(t, e) {
                ...
                return (
                    ...
                    (e = (0, N.default)(!0, {}, S.DEFAULTS, { modules: o }, n, e)), ["bounds", "container", "scrollingContainer"].forEach(function(t) {
                ...
                if (
                    ...
                    if (
                        ((a = this.emitter).emit.apply(
                                a, [g.default.events.EDITOR_CHANGE].concat(s)
                            ),
            ...
            function s(t, e, n, r, o) {
                ...
                return (
                    ...
                    (o = o || g.default.sources.API), [t, e, i, o]
                );
            }
            ...
            var c =
                ...
                f = (function() {
                    function t(t, e) {
                        ...
                        try {
                            for (
                                var l, a = t[Symbol.iterator](); !(r = (l = a.next()).done) &&
                                (n.push(l.value), !e || n.length !== e); r = !0
                            );
                        } catch (t) {
                            (o = !0), (i = t);
                        } finally {
                ...
                return (
                    ...
                    a(e, [{
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                for (
                                    var e = arguments.length, n = Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++
                                )
                                    n[r - 1] = arguments[r];
        ...
        function(t, e, n) {
            ...
            function r(t) {
                if (i.indexOf(t) <= i.indexOf(l)) {
                    for (
                        var e, n = arguments.length, r = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++
                    )
                        r[o - 1] = arguments[o];
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    e.classList.add("ql-picker-options"),
                                        ...
                                        (this.options = e), [].slice.call(this.select.options).forEach(function(n) {
                                            var r = t.buildItem(n);
                ...
                s = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.build = function() {
                            var t = this;
                            (this.children = new i.default()), [].slice
                        ...
                        (e.prototype.descendant = function(t, n) {
                            ...
                            return (null == t.blotName && t(o)) ||
                                (null != t.blotName && o instanceof t) ? [o, i] :
                                o instanceof e ?
                ...
                function e(n, r, o, i, c) {
                    function f(n, o) {
                        ...
                        if (Object.getOwnPropertySymbols)
                            for (
                                var _ = Object.getOwnPropertySymbols(n), g = 0; g < _.length; g++
                            ) {
                                var O = _[g],
                        ...
                        if (c)
                            for (
                                var x = Object.getOwnPropertyNames(n), g = 0; g < x.length; g++
                            ) {
                                var k = x[g],
                    ...
                    return (
                        s(t, [{
                            ...
                            },
                            {
                                key: "normalizeNative",
                                value: function(t) {
                                    if (!l(this.root, t.startContainer) ||
                                    ...
                                    return (
                                        [e.start, e.end].forEach(function(t) {
                                            for (
                                                var e = t.node, n = t.offset; !(e instanceof Text) && e.childNodes.length > 0;
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    if (
                                        ((this.lastRange = o),
                                            null != this.lastRange &&
                                            (this.savedRange = this.lastRange), !(0, d.default)(e, this.lastRange))
                                    ) {
                                        var l;
                                        !this.composing &&
                                            null != i &&
                                        ...
                                        if (
                                            ((l = this.emitter).emit.apply(
                                                    l, [v.default.events.EDITOR_CHANGE].concat(s)
                                                ),
            ...
            function s(t, e) {
                ...
                return (
                    ...
                    o(n, "handler", function(n) {
                        ...
                        return (!(b(o, 1)[0] instanceof T.default.Embed) ||
                            (t === D.keys.LEFT ?
                                e ?
                ...
                D = (function(t) {
                    function e(t, n) {
                        ...
                        return (
                            ...
                            (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0 },
                                    u
                                ),
                                r.addBinding({ key: e.keys.DELETE }, { collapsed: !0 }, c)) :
                            (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ },
                                    u
                                ),
                                r.addBinding({ key: e.keys.DELETE }, { collapsed: !0, suffix: /^.?$/ },
                                    c
                                )),
                    ...
                    return (
                        ...
                        g(e, null, [{
                            ...
                            value: function(t, e) {
                                return (
                                    (e = y(e)), !["altKey", "ctrlKey", "metaKey", "shiftKey"].some(
                                        function(n) {
                                                ...
                                                if (null != i && t.quill.hasFocus()) {
                                                    ...
                                                    o.some(function(e) {
                                                        ...
                                                        if (Array.isArray(e.format)) {
                                                            ...
                                                            return !1;
                                                        return (!(null != e.prefix && !e.prefix.test(x.prefix)) &&
                        ...
                        u(e, [{
                            ...
                            },
                            {
                                ...
                                value: function(t, n) {
                                    ...
                                    for (
                                        var r = this, o = 0; null != r && r.statics.scope !== f.default.Scope.BLOCK_BLOT;
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (!this.selection.composing && null != this.parent) {
                                        ...
                                        for (; null != this.domNode.lastChild &&
            ...
            var l = (function() {
                ...
                c = (function(t) {
                    function e(t, n) {
                        ...
                        return (
                            (i.label.innerHTML = n),
                            i.container.classList.add("ql-color-picker"), [].slice
            ...
            var l = (function() {
                ...
                c = (function(t) {
                    function e(t, n) {
                        ...
                        return (
                            i.container.classList.add("ql-icon-picker"), [].forEach.call(
                ...
                a = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.optimize = function(e, n) {
                            ...
                            for (
                                var l = [].slice.call(this.observer.takeRecords()); l.length > 0;
                                ...
                                for (
                                    u.forEach(function(t) {
                                        ...
                                        null != e &&
                                            (e.domNode === t.target &&
                                                ("childList" === t.type ?
                                                    (a(i.find(t.previousSibling, !1)), [].forEach.call(t.addedNodes, function(t) {
                                                        var e = i.find(t, !1);
                                                        a(e, !1),
        ...
        function(t, e) {
            ...
            function o(t, e) {
                ...
                (s[l + 1] = 0), (u[l + 1] = 0);
                for (
                    var f = n - r, h = f % 2 != 0, p = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++
                ) {
                    ...
                    for (var N = -m + b; N <= m - g; N += 2) {
                        ...
                        E =
                            ...
                            u[k - 1] + 1;
                        for (
                            var j = E - N; E < n && j < r && t.charAt(n - E - 1) == e.charAt(r - j - 1);
            ...
            function s(t, e) {
                ...
                return (
                    ...
                    ((h = i[0]), (p = i[1]), (c = i[2]), (f = i[3])), [c, f, h, p, i[4]]
                );
            }
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    ...
                                    var o = [n, r].map(function(t) {
                                        ...
                                        for (
                                            var e = (0, O.bubbleFormats)(t.shift()); Object.keys(e).length > 0;
        ...
        function(t, e, n) {
            ...
            function c(t, e) {
                for (
                    var n = "", r = t.ops.length - 1; r >= 0 && n.length < e.length;
                    --r
                ) {
                    var o = t.ops[r];
            ...
            function f(t) {
                return (
                    0 !== t.childNodes.length && ["block", "list-item"].indexOf(u(t).display) > -1
                );
            }
            ...
            function h(t, e, n) {
                return t.nodeType === t.TEXT_NODE ?
                    ...
                    t.nodeType === t.ELEMENT_NODE ? [].reduce.call(
                        t.childNodes || [],
                        function(r, o) {
                            var i = h(o, e, n);
                            return (
            ...
            function g(t, e) {
                ...
                for (
                    var r = -1, o = t.parentNode; !o.classList.contains("ql-clipboard");
                ...
                v = (function(t) {
                    function e(t, n) {
                        ...
                        return (
                            ...
                            r.quill.keyboard.addBinding({ key: "Z", shortKey: !0 },
                                r.undo.bind(r)
                            ),
                            r.quill.keyboard.addBinding({ key: "Z", shortKey: !0, shiftKey: !0 },
                                r.redo.bind(r)
                            ),
                            /Win/i.test(navigator.platform) &&
                            r.quill.keyboard.addBinding({ key: "Y", shortKey: !0 },
                                r.redo.bind(r)
                            ),
                            r
                        );
                        ...
                        u(e, [{
                            ...
                            value: function(t) {
                                t.container.classList.add("ql-snow"),
                                    ...
                                    this.quill.keyboard.addBinding({ key: "K", shortKey: !0 },
                                        function(e, n) {
